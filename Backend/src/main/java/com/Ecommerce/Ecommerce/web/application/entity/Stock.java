...
public class Stock {
    ...
    public Stock(Long Stock_id, Long product_id, Long store_id, Date manufacturing_data, Date exp_date, String quantity, Long min_Limit, Long MRP, Long discount, Long sale_Price) {
        stock_id = Stock_id;
        this.product_id = product_id;
        Store_id = store_id;
        Manufacturing_data = manufacturing_data;
