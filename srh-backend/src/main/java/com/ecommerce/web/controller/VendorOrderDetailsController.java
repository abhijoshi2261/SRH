...
import com.ecommerce.web.service.VendorOrderDetailsService;
...
public class VendorOrderDetailsController {
    ...
    public VendorOrderDetails updateVendorOrderDetails(@PathVariable("id") Long id,
            @RequestBody VendorOrderDetails vendorOrderDetails) {
